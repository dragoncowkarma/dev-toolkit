  ...
  return (
    <section className="json-type-generator" aria-labelledby="json-type-generator-title">
      ...
      <fieldset className="json-type-generator__settings">
        ...
        <label>
          Root type name
          <input name="rootName" value={settings.rootName} onChange={updateSetting}
            aria-label="Root type name" />
        </label>
        <label>
          Declaration
          <select name="declaration" value={settings.declaration} onChange={updateSetting}
        ...
        <label>
          Indentation
          <select name="indent" value={settings.indent} onChange={updateSetting}
        ...
        <label>
          <input type="checkbox" name="optionalProperties" checked={settings.optionalProperties}
            onChange={updateSetting} />
          Optional properties
        </label>
        <label>
          <input type="checkbox" name="readonly" checked={settings.readonly}
            onChange={updateSetting} />
          Readonly properties
        </label>
      </fieldset>
      <div className="json-type-generator__panes">
        <div className="json-type-generator__pane">
          <label htmlFor="json-type-input">Sample JSON</label>
          <textarea id="json-type-input" value={source}
            onChange={(event) => setSource(event.target.value)} aria-label="Sample JSON"
            placeholder="Paste JSON here" spellCheck="false" />
        </div>
        <div className="json-type-generator__pane">
          <div className="json-type-generator__output-heading">
            <label htmlFor="json-type-output">TypeScript declaration</label>
            <button type="button" onClick={copyOutput} disabled={!output}
              aria-label="Copy TypeScript declaration">
              Copy
            </button>
          </div>
          <textarea id="json-type-output" value={output} readOnly
            aria-label="TypeScript declaration" placeholder="Your declaration will appear here"
            spellCheck="false" />
        </div>
      </div>
