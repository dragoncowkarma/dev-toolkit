...
export const HTTP_STATUS_CODES = [
  ...
  [102, 'Processing', 'The server is processing the request but has no response yet.'],
  ...
  [301, 'Moved Permanently', 'The resource permanently moved to the URL in the Location header.'],
  ...
  [307, 'Temporary Redirect', 'The resource is at another URL with the method unchanged.'],
  [
    308,
    'Permanent Redirect',
    'The resource permanently moved to another URL with its method unchanged.',
  ],
  ...
  [
    ...
    'A proxy requires authentication before the request can proceed.',
  ],
  ...
  [413, 'Content Too Large', 'The request content is larger than the server will process.'],
  ...
  [416, 'Range Not Satisfiable', 'The requested range cannot be fulfilled for the resource.'],
  [417, 'Expectation Failed', 'The server cannot meet an expectation in the request header.'],
  ...
  [422, 'Unprocessable Content', 'The well-formed request cannot be processed as instructed.'],
  ...
  [431, 'Request Header Fields Too Large', 'The request header fields exceed the server limit.'],
  ...
  [506, 'Variant Also Negotiates', 'The server has a content negotiation configuration error.'],
  [
    507,
    'Insufficient Storage',
    'The server cannot store the representation needed to complete this request.',
  ],
  [508, 'Loop Detected', 'The server detected an infinite loop while processing the request.'],
  [510, 'Not Extended', 'The request needs extensions before the server can fulfill it.'],
